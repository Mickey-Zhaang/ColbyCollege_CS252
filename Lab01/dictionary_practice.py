...
my_dict = dict(zip(fruit, hundreds))
print(my_dict.keys())
...
number_dict = {
    "hi": 1,
    "there": [10, 20],
    "cs251": [62, 96, 35, 70, 97, 89, 35, 34, 67, 62, 44, 4, 42, 33, 32, 78, 64],
}
...
"""
idx = number_dict['cs251'].index(4)
print(f'The index of the 4 is {idx}')
...
store_dict = {'shoe_store': [], 'music_store': []}
for item in delivery:
    if item == 'shoes':
        store_dict['shoe_store'].append(item)
    else:
        store_dict['music_store'].append(item)
    print("shoe_store:", store_dict['shoe_store'])
    print("music_store:", store_dict['music_store'])
